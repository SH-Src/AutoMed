...
from models_new.ablation_model_search import *
...
def train(args):
    ...
    if args.ablation == 1:
        model = Network1(pad_id + 1, args.d_model, args.steps, loss_func)
    elif args.ablation == 2:
        model = Network2(pad_id + 1, args.d_model, args.steps, loss_func)
    elif args.ablation == 3:
        model = Network3(pad_id + 1, args.d_model, args.steps, loss_func)
    elif args.ablation == 0:
        model = Network0(pad_id + 1, args.d_model, args.steps, loss_func)
    else:
