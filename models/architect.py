...
class Architect(object):
  ...
  def __init__(self, model, args):
    ...
    self.model = model
    self.optimizer = torch.optim.Adam(self.model.arch_parameters(), lr=args.learning_rate, weight_decay=args.wdecay)
  ...
  def step(self,
    ...
    if unrolled:
        hidden = self._backward_step_unrolled(input_train, target_train, input_valid, target_valid, eta)
    else:
        hidden = self._backward_step(input_valid, target_valid)
    self.optimizer.step()
    return None
