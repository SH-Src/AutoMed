...
from models.genotypes import PRIMITIVES, STEPS, CONCAT, Genotype
from torch.autograd import Variable
from collections import namedtuple
from models.model import DARTSCell, RNNModel
...
class RNNModelSearch(RNNModel):
    ...
    def genotype(self):
      ...
      gene = _parse(torch.softmax(self.weights, dim=-1).data.cpu().numpy())
