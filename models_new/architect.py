...
class Architect(object):
    def __init__(self, model, args):
      ...
      self.optimizer = torch.optim.Adam(self.model.arch_parameters(), lr=args.arch_learning_rate, betas=(0.5, 0.999),
    ...
    def _compute_unrolled_model(self, input, target, eta, network_optimizer):
      ...
      unrolled_model = self._construct_model_from_theta(torch.sub(theta, moment + dtheta, alpha=eta))
